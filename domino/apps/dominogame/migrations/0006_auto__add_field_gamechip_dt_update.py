...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'GameChip.dt_update'
        db.add_column('dominogame_gamechip', 'dt_update',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default=datetime.datetime(2012, 8, 20, 0, 0), blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'GameChip.dt_update'
        db.delete_column('dominogame_gamechip', 'dt_update')
    ...
    models = {
        ...
        'dominogame.gamechip': {
            ...
            'dt_update': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
