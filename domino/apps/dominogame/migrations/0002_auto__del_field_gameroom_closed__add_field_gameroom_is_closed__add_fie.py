...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'GameRoom.closed'
        db.delete_column('dominogame_gameroom', 'closed')

        # Adding field 'GameRoom.is_closed'
        db.add_column('dominogame_gameroom', 'is_closed',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'GameRoom.is_finished'
        db.add_column('dominogame_gameroom', 'is_finished',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'GameRoom.closed'
        db.add_column('dominogame_gameroom', 'closed',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Deleting field 'GameRoom.is_closed'
        db.delete_column('dominogame_gameroom', 'is_closed')

        # Deleting field 'GameRoom.is_finished'
        db.delete_column('dominogame_gameroom', 'is_finished')
