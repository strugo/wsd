...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'GameChip.dt_update'
        db.alter_column('dominogame_gamechip', 'dt_update', self.gf('django.db.models.fields.DateTimeField')(null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'GameChip.dt_update'
        raise RuntimeError("Cannot reverse this migration. 'GameChip.dt_update' and its values cannot be restored.")
    ...
    models = {
        ...
        'dominogame.gamechip': {
            ...
            'dt_update': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'prev': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'next_chip'", 'null': 'True', 'to': "orm['dominogame.GameChip']"}),
